...
const SHOPIFY_STORE_PERMANENT_DOMAIN = 'karvix-emporium-m88ni.myshopify.com';
const SHOPIFY_STOREFRONT_URL = `https://${SHOPIFY_STORE_PERMANENT_DOMAIN}/api/${SHOPIFY_API_VERSION}/graphql.json`;
const SHOPIFY_STOREFRONT_TOKEN = '6728c23bafdbfbe8d34dac1dcde6840f';
...
export { CART_QUERY, formatCheckoutUrl, isCartNotFoundError };
